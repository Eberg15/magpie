  ...
  public String getResponse(String statement)
  {
    ...
    else if (findKeyword(statement,"potato") >= 0)
    {
      response = "The Irish potato famine happened during the years of 1845 to 1852 and decimated the irish population";
               ...
               || statement.indexOf("hamburger")>=0
               || statement.indexOf("taco")>=0)
    {
      response = "I also like food";
    }
    // when there is more than 1 keyword in the statement, it picks the first one
